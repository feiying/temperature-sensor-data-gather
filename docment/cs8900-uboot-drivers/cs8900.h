...
#define CS8900_RTDATA *(volatile unsigned short *)(CS8900_BASE+0x00*2)
#define CS8900_TxCMD  *(volatile unsigned short *)(CS8900_BASE+0x02*2)
#define CS8900_TxLEN  *(volatile unsigned short *)(CS8900_BASE+0x03*2)
#define CS8900_ISQ    *(volatile unsigned short *)(CS8900_BASE+0x04*2)
#define CS8900_PPTR   *(volatile unsigned short *)(CS8900_BASE+0xa)
#define CS8900_PDATA  *(volatile unsigned short *)(CS8900_BASE+0xc)
